...
WITH product_data AS (
    ...
    FROM
        joshodey2178_staging.fact_reviews AS r
        LEFT JOIN joshodey2178_staging.dim_products AS p ON r.product_id = p.product_id
    GROUP BY
...
ordered_day_data AS (
    ...
    FROM
        joshodey2178_staging.fact_orders AS o
...
public_holiday_data AS (
    ...
    FROM
        joshodey2178_staging.dim_dates AS d
...
FROM joshodey2178_staging.fact_reviews AS r
...
FROM joshodey2178_staging.fact_shipment_deliveries AS s
INNER JOIN joshodey2178_staging.fact_orders AS o
...
INSERT INTO joshodey2178_analytics.best_performing_product
SELECT
...
-- Check process
SELECT *
FROM joshodey2178_analytics.best_performing_product